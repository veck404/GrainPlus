              ...
              <div className="mt-[20px]">
                ...
                >
                  <p className="w-fit font-jost text-[16px] lg:text-[18px] text-gray-700 block leading-[31px] mt-3">
                    GrainPlus Logistics is a leading Nigerian logistics company
                    with over a decade of experience in the industry. We
                    specialize in providing efficient, customer-oriented
                    services, meticulously tailored to meet the precise needs of
                    each client. As your trusted logistics partner, we offer a
                    comprehensive suite of services including Freight
